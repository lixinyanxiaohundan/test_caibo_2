...
import sys
import os
os.chdir('/Users/Administrator/Desktop/py/TestPython1')
for file in os.listdir(os.getcwd()):
    print(file)
sys.path.append('/Users/Administrator/Desktop/py/TestPython1')
sys.path.append('/Users/Administrator/Desktop/py/TestPython1/com')
sys.path.append('/Users/Administrator/Desktop/py/TestPython1/com/caibo/case')
...
utils.mkdir("/Users/Administrator/Desktop/py/TestPython1/com/caibo/screenShots/"+now_time)  #创建截图目录
...
def creat_suite():
    ...
    discover = unittest.defaultTestLoader.discover(r'/Users/Administrator/Desktop/py/TestPython1/com/caibo/case', pattern="Test_*.py", top_level_dir=None)
    print(discover)
    # print (discover)
    # 遍历并执行每一个测试用例
...
if __name__ == "__main__":
    suite = creat_suite()
    fb = open('/Users/Administrator/Desktop/py/TestPython1/com/caibo/report/'+now_time+'/result.html', 'wb')
