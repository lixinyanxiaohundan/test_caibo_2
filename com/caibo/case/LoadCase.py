...
def creat_suite():
    ...
    discover = unittest.defaultTestLoader.discover(r'/Users/Administrator/Desktop/py/TestPython1/test_caibo_2/com/caibo/case', pattern="Test_*.py", top_level_dir=None)
    print(discover)
    # print (discover)
    # 遍历并执行每一个测试用例
